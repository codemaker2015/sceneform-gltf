  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    ModelRenderable.builder()
        .setSource(
            this,
            Uri.parse(
                "https://github.com/codemaker2015/3d-models/blob/master/glb_files/Cappuccino_cup.glb?raw=true"))
        ...
        .exceptionally(
            throwable -> {
              Toast toast =
                  Toast.makeText(this, "Unable to load cup renderable", Toast.LENGTH_LONG);
    ...
    arFragment.setOnTapArPlaneListener(
        (HitResult hitResult, Plane plane, MotionEvent motionEvent) -> {
          ...
          Node cupTitleNode = new Node();
          cupTitleNode.setParent(model);
          cupTitleNode.setEnabled(false);
          cupTitleNode.setLocalPosition(new Vector3(0.0f, 1.0f, 0.0f));
          ViewRenderable.builder()
                  .setView(this, R.layout.cup_card_view)
                  .build()
                  .thenAccept(
                          (renderable) -> {
                              cupTitleNode.setRenderable(renderable);
                              cupTitleNode.setEnabled(true);
                          })
                  .exceptionally(
                          (throwable) -> {
